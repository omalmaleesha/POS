...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const navigateDeleteCustomer = document.getElementById("navigateDeleteCustomer");
    ...
    const navigateUpdateCustomer = document.getElementById("navigateUpdateCustomer");
    ...
    const navigateSearchCustomer = document.getElementById("navigateSearchCustomer");
